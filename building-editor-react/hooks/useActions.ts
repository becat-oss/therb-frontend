...
export function useActions(): Actions {
  ...
  const setSceneSize = useCallback(
  ...
  const addObject = useCallback(
    (object: THREE.Object3D, parent?: THREE.Object3D, index?: number) => {
  ...
  const addObjectAsHelper = useCallback(
    (object: THREE.Object3D) => {
  ...
  const updateGridHelper = useCallback(
  ...
  const updateAxesHelper = useCallback(
  ...
  const loadFile = useCallback(
    (file: File, parent?: THREE.Object3D, onLoad?: (object: THREE.Object3D | undefined, file: File) => void, onError?: (error: any) => void) => {
  ...
  const loadFiles = useCallback(
    (files: File[], parent?: THREE.Object3D, onLoad?: (object: THREE.Object3D | undefined) => void, onError?: (error: any) => void) => {
      editor.loader.loadFiles(files, undefined, parent, onLoad, onError);
    },
    [editor.loader],
  );

  const loadFileFromLocal = useCallback(
    (parent?: THREE.Object3D, onLoad?: (object: THREE.Object3D | undefined, file: File) => void, onError?: (error: any) => void) => {
      const viewportElement = document.getElementById('building-editor-viewport');
  ...
  const loadFilesFromLocal = useCallback(
    (parent?: THREE.Object3D, onLoad?: (object: THREE.Object3D | undefined) => void, onError?: (error: any) => void) => {
      const viewportElement = document.getElementById('building-editor-viewport');
      if (!viewportElement) return;
